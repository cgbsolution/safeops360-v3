...
export function DeletePermitIconButton({
  ...
  async function handleDelete(e: React.MouseEvent) {
    ...
    const ok = await confirmDialog({
      ...
      description: `Permanently delete ${permitNumber}?\n\nThis removes the permit, its workflow history, isolations, gas readings, suspensions, extensions, approvals, and any linked site safety check references. This cannot be undone.`,
      confirmLabel: "Delete",
      destructive: true
    });
    if (!ok) return;
